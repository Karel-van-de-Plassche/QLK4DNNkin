...
[chii] = qlkANNk(prof.rlti,prof.q,prof.tite,prof.s,parametre.netief.max_qlk,parametre.netief.min_qlk,parametre.netief.net,parametre.netief.prepros);
[chie] = qlkANNk(prof.rlti,prof.q,prof.tite,prof.s,parametre.neteef.max_qlk,parametre.neteef.min_qlk,parametre.neteef.net,parametre.neteef.prepros);
[D] = qlkANNk(prof.rlti,prof.q,prof.tite,prof.s,parametre.netdfe.max_qlk,parametre.netdfe.min_qlk,parametre.netdfe.net,parametre.netdfe.prepros);
[Vt] = qlkANNk(prof.rlti,prof.q,prof.tite,prof.s,parametre.netvte.max_qlk,parametre.netvte.min_qlk,parametre.netvte.net,parametre.netvte.prepros);
[Vc] = qlkANNk(prof.rlti,prof.q,prof.tite,prof.s,parametre.netvce.max_qlk,parametre.netvce.min_qlk,parametre.netvce.net,parametre.netvce.prepros);
